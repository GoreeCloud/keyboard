...
def main() -> None:
    ...
    print(
        ...
        f"{GOVERNED_GLAZE_BASELINE} at {GOVERNED_GLAZE_REVISION}; Platform Contract 2.0 classifies Keyboard as Forge/development and remains migration-required/nonconformant; "
