...
- Local swipe typing with transient QWERTY geometry, a deliberate minimum travel/time/multi-key activation threshold to reduce fast-tap false positives, packaged plus optional learned vocabulary ranking, bounded endpoint-drift tolerance, and up to three post-swipe correction candidates.
