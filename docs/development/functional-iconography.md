...
**Status:** Development candidate — 0.1.22-dev  
...
The implementation remains first-party and custom-drawn. The active 0.1.22 Development candidate applies this system directly to the native Android KeyboardView.
