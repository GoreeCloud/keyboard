...
GoreeCloud Keyboard 0.1.13-dev carries a bounded horizontal cursor-control implementation from the rendered Space key. It is a GoreeCloud-owned reimplementation of the earlier Draft PR #63/#64 design adapted to the current PR #97 runtime and settings architecture.
